...
const App: React.FC = () => {
  ...
  useEffect(() => {
    ...
    if (!apiKey || apiKey.trim() === '' || apiKey === 'undefined') {
      setApiKeyError(
        "Ключ Gemini API не найден. Пожалуйста, убедитесь, что переменное окружение GEMINI_API_KEY правильно установлено в вашей среде развертывания (например, в Vercel)."
      );
